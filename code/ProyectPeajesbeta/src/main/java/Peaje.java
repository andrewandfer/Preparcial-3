...
public class Peaje {
    ...
    private ArrayList<Cobrador> cobradoresPeajes;
    ...
    public ArrayList<Cobrador> getCobradoresPeajes() {
        return cobradoresPeajes;
    }

    public void setCobradoresPeajes(ArrayList<Cobrador> cobradoresPeajes) {
    ...
    public Cobrador buscarCobrador(String nombre) {
        for (Cobrador cobrador : cobradoresPeajes) {
